...
function run_project() {
  ...
  timeout ${TIMEOUT} docker exec ${id} mv /home/tracemop/tracemop/scripts/JavaMOPAgent.jar /home/tracemop/tracemop/scripts/no-track-no-stats-agent.jar
  
  echo "Running JavaMOP"
  timeout ${TIMEOUT} docker exec -w /home/tracemop/tracemop -e M2_HOME=/home/tracemop/apache-maven -e MAVEN_HOME=/home/tracemop/apache-maven -e CLASSPATH=/home/tracemop/aspectj-1.9.7/lib/aspectjtools.jar:/home/tracemop/aspectj-1.9.7/lib/aspectjrt.jar:/home/tracemop/aspectj-1.9.7/lib/aspectjweaver.jar: -e PATH=/home/tracemop/apache-maven/bin:/usr/lib/jvm/java-8-openjdk/bin:/home/tracemop/aspectj-1.9.7/bin:/home/tracemop/aspectj-1.9.7/lib/aspectjweaver.jar:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin ${id} timeout ${TIMEOUT} bash scripts/run_tracemop.sh ${repo} ${sha} /home/tracemop/output false true javamop &>> ${OUTPUT_DIR}/${project_name}/docker.log
